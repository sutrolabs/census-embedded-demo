  ...
  return (
    <button
      className={`
        ...
        data-[solid]:border-emerald-700 data-[solid]:bg-emerald-700 data-[solid]:text-slate-50
        data-[solid]:enabled:hover:border-emerald-600 data-[solid]:enabled:hover:bg-emerald-600 data-[solid]:enabled:hover:text-slate-50
