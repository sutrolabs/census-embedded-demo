  ...
  return (
    <>
      ...
      <div className="flex flex-row items-end justify-between gap-4 border-emerald-600 bg-emerald-400 p-2 md:fixed md:h-screen md:w-2/5 md:flex-col md:items-center md:justify-start md:p-6 xl:w-1/4">
        ...
        {/* Desktop Navbar */}
        <nav className="hidden flex-col gap-4 self-start overflow-x-auto px-6 py-8 md:flex">
  ...
  return (
    <Link href={href}>
      <a
        ...
        data-[selected]:border-stone-900 data-[selected]:font-bold md:border-b-0 md:border-l-2 md:pl-2 md:text-2xl"
